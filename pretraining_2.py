...
from models.trainer_2 import pretraining_training_validation_testing
...
if __name__ == "__main__":
    ...
    assert config['ssl'] == True, "SSL is not implemented for this script, please set --ssl True to use self-supervised learning."
    ...
    dataset = PhysioDataset(
        ...
        mask_ratio=config['masking_ratio']
    )
