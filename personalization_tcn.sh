...
python personalization.py \
    ...
    --input_seq_len_s 10 \
    --embed_dim 128 \
    --pretrained_model_ckpt_path ./checkpoints/tcn_ppg_percentile/tcn_ppg_percentile-TCN-2025_12_03-09_29_01/tcn_ppg_percentile_best_maml \
    --pretraining_feats_stats ./checkpoints/tcn_ppg_percentile/tcn_ppg_percentile-TCN-2025_12_03-09_29_01/tcn_ppg_percentile_embedding_stats.npz \
