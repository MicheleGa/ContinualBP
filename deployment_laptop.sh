# Drift Aware Personalization ~ Deployment on laptop

# PPG head only adaptation - for deployment on laptop, imports in the deployment folder may require adjustments
#experiment_name="laptop_deployment_feature_replay_drift_aware_mmd"
...
experiment_name="laptop_deployment_feature_replay_drift_aware_mmd_seed_40"
mkdir "logs/$experiment_name"
cd ./models
python Proto.py \
    --fs 125 \
...
experiment_name="laptop_deployment_feature_replay_drift_aware_mmd_seed_41"
mkdir "logs/$experiment_name"
cd ./models
python Proto.py \
    --fs 125 \
