...
experiment_name="personalization_feature_replay_proto_ppg_drift_aware_mmd"
...
#experiment_name="personalization_feature_replay_proto_ppg_drift_aware_mmd_seed_40"
#mkdir "logs/$experiment_name"
#cd ./models
#python Proto.py \
#    --fs 125 \
...
#experiment_name="personalization_feature_replay_proto_ppg_drift_aware_mmd_seed_41"
#mkdir "logs/$experiment_name"
#cd ./models
#python Proto.py \
#    --fs 125 \
