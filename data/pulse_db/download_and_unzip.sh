...
## Unzip
# To list the files in the archive and check integrity: 7zz l first_archive_part.zip.001
# To unzip the files in the archive: 7zz x first_archive_part.zip.001
#7zz x PulseDB_MIMIC.zip.001
#7zz x PulseDB_Vital.zip.001

## Convert to numpy arrays
python convert2numpy.py --in_folder './PulseDB_Vital' --out_folder './vital_db_npz' --index_file 'pulse_db_vital_db_index.csv' --n_jobs 4