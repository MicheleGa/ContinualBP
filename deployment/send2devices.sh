...
scp ./deployment_component_factory.py ./deployment_maml.py ./DriftDetectors.py ./Proto.py ./run_subject_cli.py ./run_subject.py ./power_monitor.c iris@toaster.local:~/Documents/ContinualBP/deployment/
