...
# Always-on Baseline
#experiment_name="pi_deployment_feature_replay_always_on"
...
# MMD Detector
#experiment_name="pi_deployment_feature_replay_drift_aware_mmd"
#mkdir "logs/$experiment_name"
#cd ./models
#python Proto.py \
#    --fs 125 \
...
# Seed 40
experiment_name="pi_deployment_feature_replay_always_on_seed_40"
mkdir "logs/$experiment_name"
cd ./models
python Proto.py \
    --fs 125 \
...
# MMD Detector
experiment_name="pi_deployment_feature_replay_drift_aware_mmd_seed_40"
mkdir "logs/$experiment_name"
cd ./models
python Proto.py \
    --fs 125 \
...
# Seed 41
experiment_name="pi_deployment_feature_replay_always_on_seed_41"
mkdir "logs/$experiment_name"
cd ./models
python Proto.py \
    --fs 125 \
...
# MMD Detector
experiment_name="pi_deployment_feature_replay_drift_aware_mmd_seed_41"
mkdir "logs/$experiment_name"
cd ./models
python Proto.py \
    --fs 125 \
