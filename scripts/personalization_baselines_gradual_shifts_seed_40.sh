...
experiment_name="personalization_no_adapt_proto_ppg_calibration_size_1_gradual_shifts_seed_40"
...
experiment_name="personalization_online_proto_ppg_calibration_size_1_gradual_shifts_seed_40"
mkdir "logs/$experiment_name"
cd ./models
python Proto.py \
    --fs 125 \
...
experiment_name="personalization_online_from_scratch_proto_ppg_calibration_size_1_gradual_shifts_seed_40"
mkdir "logs/$experiment_name"
cd ./models
python Proto.py \
    --fs 125 \
...
experiment_name="personalization_feature_replay_proto_ppg_calibration_size_1_gradual_shifts_seed_40"
mkdir "logs/$experiment_name"
cd ./models
python Proto.py \
    --fs 125 \
...
experiment_name="personalization_lwf_proto_ppg_calibration_size_1_gradual_shifts_seed_40"
mkdir "logs/$experiment_name"
cd ./models
python Proto.py \
    --fs 125 \
...
experiment_name="personalization_ewc_proto_ppg_calibration_size_1_gradual_shifts_seed_40"
mkdir "logs/$experiment_name"
cd ./models
python Proto.py \
    --fs 125 \
...
experiment_name="personalization_agem_proto_ppg_calibration_size_1_gradual_shifts_seed_40"
mkdir "logs/$experiment_name"
cd ./models
python Proto.py \
    --fs 125 \
...
experiment_name="personalization_running_mean_proto_ppg_calibration_size_1_gradual_shifts_seed_40"
mkdir "logs/$experiment_name"
cd ./models
python Proto.py \
    --fs 125 \
