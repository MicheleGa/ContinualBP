...
experiment_name="personalization_feature_replay_proto_embed_dim_32_buffer_size_64_ppg_drift_aware_mmd_seed_41"
...
experiment_name="personalization_feature_replay_proto_embed_dim_32_buffer_size_32_ppg_drift_aware_mmd_seed_41"
mkdir "logs/$experiment_name"
cd ./models
python Proto.py \
    --fs 125 \
...
experiment_name="personalization_feature_replay_proto_embed_dim_32_buffer_size_16_ppg_drift_aware_mmd_seed_41"
mkdir "logs/$experiment_name"
cd ./models
python Proto.py \
    --fs 125 \
